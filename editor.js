    ...
    <div class="sandmod-maincontent">
        ...
        <header class="sandmod-header">
            <div class="sandmod-logo">
                <img src="/sandmodenginetutorials/assets//logo_sandmod.svg" alt="SandMod Logo" class="sandmod-logo-icon">
            </div>
        </header>
        <div class="sandmod-links">
            <ul class="sandmod-links-list">
                <li><a href="/sandmodenginetutorials/" class="sandmod-link-sidebar active" target="_self" title="Tutorials">
                    <span>
                ...
                <li><a href="/sandmodenginetutorials/assets.html" class="sandmod-link-sidebar" target="_self" title="Assets">
                    <span>
                    ...
                    <li><a href="/sandmodenginetutorials/" class="sandmod-link-sidebar" target="_self" title="BlockMan Creator Center">
                    <span>
                ...
                <div class="sandmod-sidebar-tool-btn-area">
                    ...
                    <ul class="sandmod-sidebar-tools-list">
                        <li><a href="/sandmodenginetutorials/themes.html" class="sandmod-sidebar-tool" title="themes">
                            <span>
                        ...
                        <li><a href="/sandmodenginetutorials/create.html" class="sandmod-sidebar-tool" title="create tutorial">
                            <span>
                        ...
                        <li><a href="/sandmodenginetutorials/upload.html" class="sandmod-sidebar-tool" title="upload assets">
                            <span>
                        ...
                        <li><a href="/sandmodenginetutorials/favorites.html" class="sandmod-sidebar-tool" title="favorites">
                            <span>
